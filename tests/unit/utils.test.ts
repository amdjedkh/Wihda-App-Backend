...
describe("Phone Validation (Algerian)", () => {
  it("should accept valid Algerian phone numbers", () => {
    expect(isValidPhone("+213600000000")).toBe(true);
    expect(isValidPhone("+213612345678")).toBe(true);
    expect(isValidPhone("+213700000000")).toBe(true);
  ...
  it("should handle spaces in phone numbers", () => {
    expect(isValidPhone("+213 600 000 000")).toBe(true);
